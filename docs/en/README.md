...
```powershell
corepack pnpm dsh plugin --profile web add github:<your-github-username>/dsh-synapse
```
...
```yaml
allowBuilds:
  "dsh-synapse@https://codeload.github.com/<your-github-username>/dsh-synapse/tar.gz/<commit>": true
```
