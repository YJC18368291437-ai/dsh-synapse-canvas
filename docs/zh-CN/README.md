...
```powershell
corepack pnpm dsh plugin --profile web add github:<你的GitHub用户名>/dsh-synapse
```
...
```yaml
allowBuilds:
  "dsh-synapse@https://codeload.github.com/<你的GitHub用户名>/dsh-synapse/tar.gz/<commit>": true
```
